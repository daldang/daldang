...
export default function RecordUpdatePage({
  ...
  const recorId = router.query.id as string;
  ...
  const updateDesertLog = api.desertLog.updateDesertLog.useMutation();
  ...
  const handleSubmit = async () => {
    ...
    updateDesertLog.mutate(
      ...
      },
      {
        onSuccess() {
          removeItem();
          void router.push(`/records/${recorId}`);
        },
      }
    );
  };
